    ...
    var canvasManager = {
        ...
        createNodeByDrag: function (sNodeName, $thisClone, mDown, thisWidth, thisHeight, pageX, pageY) {
            ...
            if (subWidth > 0 &&subHeight>0&& mDown) {
                ...
                node.textOffsetY = 5;
               // node.alarm='hehe';
                node.setImage('./images/' + imgName + '.png');
        ...
        _createNode: function (obj) {
            ...
            obj.imgName&&node.setImage('./images/' + obj.imgName + '.png');
            for (var i in obj) {
                node[i] = obj[i];
            }

...
var dragManager = {
    ...
    getTopoData: function () {
        ...
        var data = [{
            ...
            "opr": "mod",
            "line": [{
                "id": "front149182555479257038",
                "from_id": "1491623966792493877",
                "to_id": "1491623970341717271",
                "json": {
                    "_id": "front149182555479257038",
            ...
            "node": [{
                ...
                "id": "1491813260660786069",
                "name": "",
                "nodeType": "container",
                "json": {
                    "_id": "1491813260660786069",
                    "childsArr": ["1491623970341717271", "1491623966792493877"],
                    "alarm": null,
                    "childDragble": true,
            ...
            "opr": "mod",
            "line": [{
                "id": "1491813281445315560",
                "from_id": "1491623966792493877",
                "to_id": "1491623970341717271",
                "json": {
                    "_id": "1491813281445315560",
                    "nodeAId": "1491623966792493877",
                    "nodeZId": "1491623970341717271",
                    "linkType": "dashed",
                    "elementType": "link",
            ...
            "opr": "mod",
            "line": [{
                "id": "front14918252656121512",
                "from_id": "1491623966792493877",
                "to_id": "1491623970341717271",
                "json": {
                    "_id": "front14918252656121512",
                    "nodeAId": "1491623966792493877",
                    "nodeZId": "1491623970341717271",
                    "linkType": "dashed",
                    "elementType": "link",
            ...
            "opr": "mod",
            "line": [{
                "id": "front1491825556611703712",
                "from_id": "1491623966792493877",
                "to_id": "1491623970341717271",
                "json": {
                    "_id": "front1491825556611703712",
                    "nodeAId": "1491623966792493877",
                    "nodeZId": "1491623970341717271",
                    "linkType": "dashed",
                    "elementType": "link",
                ...
                "id": "front1491825556612252519",
                "from_id": "1491623966792493877",
                "to_id": "1491816376906649894",
                "json": {
                    "_id": "front1491825556612252519",
                    "nodeAId": "1491623966792493877",
                    "nodeZId": "1491816376906649894",
                    "linkType": "Link",
                    "elementType": "link",
                    "x": 0,
                    "y": 0,
                ...
                "id": "front1491825556613382931",
                "from_id": "1491623966792493877",
                "to_id": "front1491825259314287807",
                "json": {
                    "_id": "front1491825556613382931",
                    "nodeAId": "1491623966792493877",
                    "nodeZId": "front1491825259314287807",
                    "linkType": "Link",
                    "elementType": "link",
                    "x": 0,
                    "y": 0,
                ...
                "id": "front1491825560903206129",
                "from_id": "1491623966792493877",
                "to_id": "front149182555854458837",
                "json": {
                    "_id": "front1491825560903206129",
                    "nodeAId": "1491623966792493877",
                    "nodeZId": "front149182555854458837",
                    "linkType": "arrow",
                    "elementType": "link",
                    "x": 0,
                    "y": 0,
            ...
            "node": [{
                ...
                "id": "front1491825259314287807",
                "name": "CRM系统",
                "nodeType": "node",
                "json": {
                    "_id": "front1491825259314287807",
                    "imgName": "iconType2",
                    "textBreakNumber": 5,
                    "textLineHeight": 15,
                    "elementType": "node",
                ...
                "id": "front149182555854458837",
                "name": "CRM系统",
                "nodeType": "node",
                "json": {
                    "_id": "front149182555854458837",
                    "imgName": "iconType2",
                    "textBreakNumber": 5,
                    "textLineHeight": 15,
                    "elementType": "node",
                    "x": 372.00000381469727,
                    "y": 24.66668701171875,
                    "width": 50,
                    "height": 50,
                    "visible": true,
                ...
                "id": "1491816376906649894",
                "name": "应用性能管理",
                "nodeType": "containerNode",
                "json": {
                    "_id": "1491816376906649894",
                    "childsArr": ["1491816376905230710", "1491816376905380996", "1491816376906863164", "1491816376906962966"],
                    "childDragble": false,
                    ...
                    "borderRadius": 0,
                    "childsNodeArr": [{
                        "_id": "1491816376905230710",
                        "textBreakNumber": 8,
                        "textLineHeight": 13,
                        "parentType": "containerNode",
                        "elementType": "node",
                        "x": 711.0000038146973,
                        "y": 143.6666717529297,
                        "width": 0,
    ...
    setTopoAdd: function () {
        ...
        $('.topoChooseArea').on('click', '.topuAdd-tab', function () {
            var self = this;
            var html = '<div id="addtopuTab">' +
                    '<label class="TopuLabel-font">类型</label>'+
                '    <select id="addTabselect" class="form-input">' +
                '    <option value="1">系统拓扑</option>' +
                '    <option value="2">流程拓扑</option>' +
                '    <option value="3">物理拓扑</option>' +
                '    <option value="4">逻辑拓扑</option>' +
                '    </select>' +
                    '<label class="TopuLabel-font">别名</label>'+
    ...
    _setContextmenu: function () {
        ...
        $("#contextmenuNode a").click(function () {
            ...
            if (text == '更改颜色') {
                ...
                $('.TopujumpDiv').css('display', 'none');
                switch (type) {
                    case '1':
                        $('.TopujumpSystem').show()
                        break;
                    case '2':
                        $('.TopujumpInstance').show()
                        break;
                    case '3':
                        $('.TopujumpHost').show()
                        break;
        ...
        //所有目录操作表单公共事件
        $('.TopujumpTitleUl .fa-times').click(function () {
            $('.TopujumpDiv').css('display', 'none');
        })
    },

        ...
        function b(c) {
            this.initialize = function(c) {
                ...
                this.paintText = function(a) {
                    ...
                    draw_long_text(b,a, e.x, e.y,this.textLineHeight,this.textBreakNumber),
                            a.closePath()
                    }
                }
                ,
        ...
        function b(c) {
                ...
                this.paint = function(a) {
                    ...
                    this.visible && (this.layout && this.layout(this, this.childs),
                        a.beginPath(),
                        a.fillStyle = "rgba(" + this.fillColor + "," + this.alpha + ")",
                        null == this.borderRadius || 0 == this.borderRadius ? a.rect(this.x, this.y, this.width, this.height) : a.JTopoRoundRect(this.x-30, this.y-30, this.width, this.height, this.borderRadius),
                        a.fill(),
                        a.closePath(),
                        this.paintText(a),
                        this.paintBorder(a))
...
//自定义方法
function draw_long_text(longtext,cxt,begin_width,begin_height,lineHeight,nNumber)
{
    ...
    var context = cxt;
    var number=nNumber!==undefined?nNumber:15;
